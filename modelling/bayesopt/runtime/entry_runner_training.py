...
def _build_runtime_override_payload(
    *,
    ...
    return {
        ...
        "xgb_search_space": runtime_cfg["xgb_search_space"],
        "resn_search_space": runtime_cfg["resn_search_space"],
        "ft_search_space": runtime_cfg["ft_search_space"],
        "ft_unsupervised_search_space": runtime_cfg["ft_unsupervised_search_space"],
